...
output_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../flows/smart_home/Smart_Motion_Sensor_lights_with_Auto_brightness_adjustment_flow.json"))
